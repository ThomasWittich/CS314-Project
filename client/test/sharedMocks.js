...
export const VALID_DISTANCES_REQUEST = JSON.stringify({
    requestType : "distances",
    earthRadius : 3959.0,
    places : [{"latitude":  "25.8",  "longitude": "80.2"},
                        {"latitude": "32.3", "longitude": "64.7"},
                        {"latitude":  "18.5", "longitude": "66.1"},
                        {"latitude":  "21.7", "longitude": "71.8"}],
...
export const VALID_FIND_REQUEST = JSON.stringify({
    requestType: "find",
    match: "apple",
    limit: 5
});
